...
class MrpProduction(models.Model):
                ...
                if prod['qty'] > 0:
                    ...
                    if bom_count:
                        ...
                        if bom:
                            ...
                            mo_id = self.sudo().create(vals).id
                            produced = self.sudo().pos_produce_product(mo_id)
                            _done = self.sudo().pos_production_done(mo_id)
                            return _done
    ...
    def pos_produce_product(self, mo_id):
        ...
        mrp_product_produce = self.env['mrp.product.produce'].create(
            {'production_id': mo.id, 'product_id': mo.product_id.id,
